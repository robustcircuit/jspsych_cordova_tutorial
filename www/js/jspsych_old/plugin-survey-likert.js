var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-likert-statement { display:block; font-size: 100%; padding-top: 10px; margin-bottom:5px; }" +
                  ".jspsych-survey-likert-opts { list-style:none; width:" +
                  w +
                  "; margin:auto; padding:0 0 20px; display:block; font-size: 80%; line-height:1.1em; }" +
                  ".jspsych-survey-likert-opt-label { line-height: 1.1em; font-size:100%; color: #444444ff; }" +
                  ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:10px; /*left:9.5%;*/ display:block; background-color:#efefef; height:6px; width:100%; }" +
                  ".jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }" +
                  ".jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }" +
                  ".jspsych-survey-likert-opts li input[type=radio] { display:block; position:relative; top:0; left:50%; margin-left:-5px; }";
          html += "</style>";
          // show preamble text
          if (trial.preamble !== null) {
              html +=
                  '<div id="jspsych-survey-likert-preamble" class="jspsych-survey-likert-preamble" style="margin-bottom:20px">' +
                      trial.preamble +
                      "</div>";
          }
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              for (var j = 0; j < question.labels.length; j++) {
                  options_string +=
                      '<li style="width:' +
                          width +
                          '%"><label class="jspsych-survey-likert-opt-label"><input type="radio" style="height:20px; width:20px; vertical-align: middle; margin-top:-3px" name="Q' +
                          question_order[i] +
                          '" value="' +
                          j +
                          '"';
